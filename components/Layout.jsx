...
const Layout = ({ children }) => {
	...
	const siteTitle =
		"Susan Morrow MSW, LCSW - Therapy Charlotte, NC";
	const siteDescription =
		"Online sessions available! Over 30 years in private practice, Susan Morrow has a solid base of experience providing therapy, consultation, coaching, and training services to individuals, couples, and families.";
			...
			itemListElement: [
				{
					...
					itemOffered: {
						...
						description:
							"Counseling for adults and young adults dealing with anxiety, depression, family issues, addictions, trauma, and loss.",
					},
				},
				{
					"@type": "Offer",
					itemOffered: {
						...
						description:
							"Evidence-based couples therapy to develop lasting, secure bonds and improve communication and intimacy.",
					},
				},
				{
					"@type": "Offer",
					itemOffered: {
						...
						name: "Family Therapy",
						description:
							"Support through family challenges, strengthening family bonds and developing support strategies.",
					},
				},
				{
					"@type": "Offer",
					itemOffered: {
						...
						name: "Online Therapy",
						description:
							"Remote counseling services via video or telephone for NC residents.",
					},
				},
			],
		},
	...
	return (
		<div className={loading ? "opacity-0" : "opacity-100 transition-opacity duration-500"}>
			<Head>
				...
				<meta
					name="keywords"
					content="therapy Charlotte NC, couples therapy, individual therapy, family therapy, online therapy, LCSW, licensed clinical social worker, Emotionally Focused Therapy, Gottman Method, Charlotte therapist"
				/>
				...
				<script
					type="application/ld+json"
					dangerouslySetInnerHTML={{
						__html: JSON.stringify(healthProfessionalSchema),
					}}
				/>
				<script
					type="application/ld+json"

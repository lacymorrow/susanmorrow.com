	...
	<div>
		...
		<div id="main">
			...
			<section id="two" className="spotlights">
				<section>
					<div className="image"><Image src="/images/headshot-2023-2.jpg" alt="Susan Morrow, Charlotte therapist" width={620} height={769} sizes="(max-width: 736px) 100vw, 40vw" /></div>
				...
				<section>
					...
					<span className="image"><Image src="/images/block-about-1.jpg" alt="Publications and research contributions" width={700} height={1050} sizes="(max-width: 736px) 100vw, 40vw" /></span>

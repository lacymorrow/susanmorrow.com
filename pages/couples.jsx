...
const Couples = () => <Layout>
	<Head>
		...
		<meta name="description" content="Expert couples therapy in Charlotte, NC using Emotionally Focused Therapy and Gottman Method. Restore intimacy, improve communication, and build lasting relationships. 30+ years experience." />
	</Head>
	...
	<div id="main" className="alt">
		<section id="one">
			<div className="inner">
				...
				<span className="image main"><img src="/images/header-couples-2.jpg" alt="Couples therapy session helping partners reconnect and improve communication" /></span>
				...
				<p>We now know how to build and protect close, healthy, loving relationships. Emotionally Focused Couples Therapy provides practical, focused navigation to lead you out of these stuck places of disconnection into a secure, loving bond. Our primary attachment bonds are crucial to our survival as a species.</p>
			</div>
		</section>
	</div>
</Layout>;

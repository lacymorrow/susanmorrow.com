	...
	<div id="main" className="alt">
		<section id="one">
			<div className="inner">
				...
				<span className="image main"><Image src="/images/header-family-2.jpg" alt="Family therapy session helping families reconnect and build stronger relationships" width={1200} height={360} priority sizes="(max-width: 736px) 100vw, 75vw" style={{ width: '100%', height: 'auto' }} /></span>

    ...
    <div id="main" className="alt">
        <section id="one">
            <div className="inner">
                ...
                <span className="image main"><img src="/images/header-couples-2.jpg" alt="Couples intensive therapy session for relationship repair and enrichment" width="1440" height="433" /></span>
